...
class WaveSim():
        ...
        def __init__(self, X, T, p : WaveSimParams, B=None):
            self.X = X
            self.T = T
            n = X.shape[0]
        ...
        def energy(self, u):
            ...
            # kinetic energy
            d = u - self.y
            kinetic = 0.5 * d.T @ self.M @ d / self.p.dt**2
        ...
        def step(self, u, u_dot, Q_ext=None, b_ext=None):
            
            z = u.copy()
            self.y = u + self.p.dt * u_dot
